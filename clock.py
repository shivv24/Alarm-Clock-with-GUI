...
def alarmclock(alarmtime):
    while True:
        ...
        if time_now == alarmtime:
            ...
            mixer.music.load(r'C:\Users\USER\Desktop\python data analysis\intern\alarma.mp3')
...
Button = Button(root, text ="set alarm", command =setalarm, bg="DodgerBlue2", fg ="white", font =('arial', 20, 'bold')) .grid(row =4, columnspan = 3)
